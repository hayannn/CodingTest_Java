...
class Solution {
    ...
    public static int bfs(int characterY, int characterX, int findY, int findX){
        int yy[] = {-1, 1, 0, 0};
        int xx[] = {0, 0, -1, 1};
        
        Queue<Integer[]> queue = new LinkedList<>();
        queue.add(new Integer[]{characterY,characterX,0});
        ...
        while(!queue.isEmpty()){
            ...
            if(preY == findY && preX == findX) return count/2;
